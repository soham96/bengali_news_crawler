...
HTTP = 'http://www.'
HTTPS = 'https://www.'
TAGS=['sport/', 'entertainment/', 'international/', 'calcutta/', 'state/', 'national/', 'searchresult']
...
def get_all_links():
    ...
    if not LINKS:
        LINKS=['https://www.anandabazar.com/searchresult/site-search-7.1881001?q=world&page=1&short=desc&slab=0&tnp=230']
